...
interface CustomSelectProps {
  ...
  invalid?: boolean
  /** Visible caption rendered above the trigger (fork callers). Plain div, not a label element, so it never alters the trigger's accessible name. */
  label?: string
}
...
export function CustomSelect({ value, onChange, options, placeholder = 'Select...', className = '', ariaLabel, invalid = false, label }: CustomSelectProps) {
